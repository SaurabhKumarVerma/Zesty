...
const Register = () => {
  ...
  return (
    <View>
      ...
      <View style={{ marginTop: 32 }}>
        ...
        <ZestyTextInput placeholder="Enter Email" style={{}} />
         ...
         <ZestyText
          text="User Name"
          preset="medium"
          style={{ color: app_color.charcoal_black, marginBottom: spacing.xs, marginTop: spacing.md }}
        />
      ...
      <Pressable style={{marginTop: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
        <Checkbox  value={isChecked} onValueChange={setChecked}  color={isChecked ? app_color.sunset_orange : app_color.light_gray} />
        <ZestyText
          text="I Agree with"
          preset="medium"
          style={{
      ...
      <View style={{flexDirection: 'row', marginTop: spacing.xl, alignItems: 'center', justifyContent: 'center'}}>
        <ZestyText text="Have an account?" preset='medium' style={{color: app_color.charcoal_black}}/>
