...
const ZestyShimmer = (props: IZestyShimmer) => {
  return (
    <ShimmerProvider duration={2000}>
      <View style={props.shimmerContainerStyle ? props.shimmerContainerStyle : styles.container}>
        <Shimmer
          ...
          gradientEnd={props.gradientEnd ? props.gradientEnd : DEFAULT_GRADIENT_END}
          gradientStart={props.gradientStart ? props.gradientStart : DEFAULT_GRADIENT_START}
          linearGradients={props.linearGradients ? props.linearGradients : DEFAULT_LINEAR_GRADIENTS}
        />
      </View>
    </ShimmerProvider>
  );
